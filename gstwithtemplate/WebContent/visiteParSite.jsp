...
<%@ include file="navbar.jsp" %>
        ...
        <div class="card  shadow mb-4">
	   		<div class="card-header  py-3"> <h6 class="m-0 font-weight-bold ">effectif et montant total es visite par site</h6></div>
	   		<div class="card-body">
                ...
                <br>
	   			...
	   			<table class="table table-striped table-bordered table-sm  " >
	   				<tr>
	   				   <th>Site</th><th>effectif</th><th>total</th>
	   				</tr>
	   				<c:forEach items="${visiteParSites}" var="liste">
	   				 <tr>
	   				     <td>${liste.nomSite}</td>
	   				     <td>${liste.nbVisiteur}</td>
	   				     <td>${liste.total  } Ar</td> 
	   				 </tr>
	   				 </c:forEach>
	   			</table>
        ...
        if(val=='type')
            ...
            $('#chercher').click(function(e) {
        	    ...
        	    if($nomSite !='' && $annee !='' )
    	    	{
    	           ...
    	           // alert($nomSite +"-"+ $annee);
    	           $.get('chercher',
                            {nomSite:$nomSite,annee:$annee},
                            function(data){
                            	$('#detail').html(data).slideDown();  
                            },
                            'text');
    	         // rafraichit la page web pour voir les modifications*/
